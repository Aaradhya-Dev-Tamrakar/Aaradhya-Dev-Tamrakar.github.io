...
1. `bootSite()` - 33 edges
2. `main()` - 24 edges
3. `Portfolio Website Tracker — v49.4` - 23 edges
4. `log_pass()` - 18 edges
...
- `KEC EPC Club Logo` --references--> `Experience — Aaradhya Dev Tamrakar`  [EXTRACTED]
  assets/images/logos/epc-club.png → experience.html
- `Fusemachines Logo` --references--> `Experience — Aaradhya Dev Tamrakar`  [EXTRACTED]
  assets/images/logos/fusemachines.png → experience.html
- `KEC Maker's Space Logo` --references--> `Experience — Aaradhya Dev Tamrakar`  [EXTRACTED]
  assets/images/logos/makerspace.png → experience.html
- `Achievements — Aaradhya Dev Tamrakar` --references--> `EU AI Act Literacy Certificate`  [INFERRED]
  achievements.html → assets/certificates/EU_AI_Act_Literacy_EU0028355472158.pdf
- `Social Preview Card (OG Image)` --references--> `Aaradhya Dev Tamrakar — Electronics Engineer & AI/ML Developer`  [EXTRACTED]
  assets/images/og-image.jpg → index.html
...
Cohesion: 0.06
Nodes (37): Aaradhya Dev Tamrakar, DataCamp Statement of Accomplishment: AI-Assisted Product Launch, Certificate of Completion: AI Fluency: Framework & Foundations, Anthropic, Amazon Web Services (AWS), DataCamp Statement of Accomplishment: Building a Go-To-Market Strategy, DataCamp Statement of Accomplishment: Cleaning Data with Generative AI, DataCamp (+29 more)

### Community 2 - "Community 2"
Cohesion: 0.12
Nodes (23): About — Aaradhya Dev Tamrakar, Achievements — Aaradhya Dev Tamrakar, KEC EPC Club Logo, Fusemachines Logo, KEC Maker's Space Logo, Social Preview Card (OG Image), Contact — Aaradhya Dev Tamrakar, EU AI Act Literacy Certificate (+15 more)
...
Cohesion: 0.08
Nodes (24): Evidence & Verification Log — v20 additions, _Last updated: 2026-08-17_, Meta, Portfolio Website Tracker — v49.4, State of Play, Status, v21 addition — both v20-flagged unmatched PDFs closed out, v22 addition — KEC IT Club "Introduction to Git" (2024) card: closed, no source file available (+16 more)
