...
const SEARCH_STATIC_INDEX = {
  ...
  },
  {
    ...
    "text": "fusemachines wk 10 — image processing hsv-based multi-class fruit segmentation across the fruits-360 dataset, plus a from-scratch canny\n              edge detector benchmarked against cv2.canny() full fruit-detection pipeline — harris corners, hough circles, contour-based bounding boxes python opencv numpy matplotlib hsv segmentation canny edge detection hough transform"
  },
  {
    "type": "project",
    ...
    "text": "fusemachines wk 9 — neu steel defect cnn pytorch cnn classifier for neu-det steel surface-defect detection — six classes, 1,800 grayscale\n              images from-scratch nn foundation → tuned cnn, 98.6%/84.7% train/val accuracy via optuna bayesian\n              search python pytorch torchvision cnn optuna scikit-learn"
  },
  {
    "type": "project",
